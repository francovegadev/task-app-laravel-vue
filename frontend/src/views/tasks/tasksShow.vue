    ...
    <div class="py-8 px-4 mx-auto max-w-screen-2xl text-center lg:py-16">
        ...
        <div class="flex flex-col bg-navbarbg px-4 py-4 rounded-sm shadow-sm w-full max-w-2xl mx-auto">
          <div class="flex w-full border border-faded rounded-sm">
            <p class="w-full p-2 border uppercase font-sans font-semibold text-lg border-faded max-w-lg mx-auto bg-gray-200">
              Título
            </p>
          ...
          <div class="flex justify-center w-full border border-faded rounded-sm">
            <p class="w-full p-2 border flex items-center justify-center font-sans font-semibold uppercase text-lg border-faded max-w-lg mx-auto bg-gray-200">
              Descripción
            </p>
            <p class="w-full p-2 font-sans max-w-lg text-lg mx-auto">{{ taskStore.task.description }}</p>
          </div>
          <div class="flex w-full border border-faded rounded-sm">
            <p class="w-full p-2 border font-sans font-semibold uppercase text-lg border-faded max-w-lg mx-auto bg-gray-200">
          ...
          <div class="flex w-full border border-faded rounded-sm">
            ...
            <p :class="['w-full p-2 font-sans max-w-lg text-lg mx-auto font-semibold', getStatusColor(taskStore.task.status)]">
          ...
          <div class="flex w-full border border-faded rounded-sm">
            ...
            <p class="w-full p-2 font-sans max-w-lg text-lg mx-auto">{{ taskStore.task.user?.name }}</p>
          </div>
        </div>
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 md:space-x-4 my-4">
            <router-link :to="{name: 'tasksView'}" class="inline-flex items-center justify-center text-white bg-primary hover:bg-gray-700 box-border border border-transparent transition-colors focus:ring-4 focus:ring-brand-medium shadow-xs font-medium rounded-base text-base px-5 py-3 focus:outline-none">
                Volver
            </router-link>
        </div>
    </div>
