...
<template>
  <form
    v-if="taskStore.task && authStore.user"
    class="max-w-xl mx-auto mt-6 bg-secondary shadow-sm px-3 py-6"
  ...
  >
    ...
    <div class="relative z-0 w-full mb-5 group">
      <label for="title" class="block mb-2.5 text-lg font-sans font-medium text-heading"
        >Título</label
      >
      <input
        type="text"
    ...
    <div class="relative z-0 w-full mb-5 group">
      <label for="description" class="lock mb-2.5 text-lg font-sans font-medium text-heading"
        >Descripción</label
      >
      <textarea
        id="description"
