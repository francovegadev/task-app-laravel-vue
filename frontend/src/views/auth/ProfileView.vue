...
<template>
    ...
    <div class="max-w-md text-left mx-auto">
      <h3 class="text-2xl font-sans text-left px-4 pb-2">Bienvenid@!! 
  ...
  <div
    class="flex mb-8 mx-10 rounded-lg md:mb-12">
    <figure
      ...
      <figcaption class="flex items-center mr-auto justify-center ">
        <div class="space-y-0.5 font-medium text-white uppercase text-left rtl:text-right ms-3">
          ...
          <div class="mb-4">
            ...
            <div class="text-lg font-sans text-gray-500 dark:text-gray-400 ">{{ user?.roles![0]?.name }}</div>
          </div>
          <!-- <div class="mb-4">
